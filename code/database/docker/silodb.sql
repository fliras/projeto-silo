...
-- -----------------------------------------------------
-- Table `silodb`.`ingredientes_receitas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `silodb`.`ingredientes_receitas` (
  `id_ingrediente` INT NOT NULL,
  `id_receita` INT NOT NULL,
  `fator_de_proporcao` DECIMAL(5,4) NOT NULL,
  INDEX `fk_ingredientes_receitas_ingredientes1_idx` (`id_ingrediente` ASC) VISIBLE,
  INDEX `fk_ingredientes_receitas_receitas1_idx` (`id_receita` ASC) VISIBLE,
  CONSTRAINT `fk_ingredientes_receitas_ingredientes1`
    FOREIGN KEY (`id_ingrediente`)
    REFERENCES `silodb`.`ingredientes` (`id_ingrediente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_ingredientes_receitas_receitas1`
